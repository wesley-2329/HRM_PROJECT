...
const Sidebar = ({ collapsed, setCollapsed, currentModule, mobileActive, setMobileActive }) => {
  ...
  const hrMenu = [
    ...
    { id: 'hr-budgeting', label: 'HR Budgeting & Cost Analytics', icon: 'fa-calculator' },
    { id: 'statutory-compliance', label: 'Statutory Compliance', icon: 'fa-scale-balanced' },
    { id: 'exit-management', label: 'Exit & F&F Management', icon: 'fa-door-open' },
