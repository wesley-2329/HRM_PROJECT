...
const Sidebar = ({ collapsed, setCollapsed, currentModule, setCurrentModule, mobileActive, setMobileActive }) => {
  ...
  const empMenu = [
    ...
    { id: 'emp-pip', label: 'PIP & Performance', icon: 'fa-star-half-stroke' },
    ...
    <aside className={`sidebar ${collapsed ? 'collapsed' : ''} ${mobileActive ? 'active' : ''}`}>
      <div>
        ...
        <div className="profile-card">
          <img src={user.avatar || 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=150'} alt="Avatar" />
