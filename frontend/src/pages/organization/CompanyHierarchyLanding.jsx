...
const CompanyHierarchyLanding = ({ mode }) => {
  ...
  return (
    <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      <OrganizationToolbar 
        ...
        description="Unified hub for corporate hierarchy: edit legal settings, configure branches, departments, designations, reporting manager structures, and visualize the company chart."
      />
...
export default CompanyHierarchyLanding;
