...
const connectDB = async () => {
  try {
    ...
    const seedHRs = [
      ...
      { id: "EMP-0001", _id: "60c72b2f9b1d8b2a3c9d7890", name: "Venkat Raman", email: "hr@company.com", role: "hr", dept: "Human Resources", password: "admin123" }
    ];
    ...
    const seedEmployees = [
      ...
      { id: "EMP-0002", _id: "60c72b2f9b1d8b2a3c9d7891", name: "Aditya Kumar", email: "employee@company.com", role: "employee", dept: "Engineering", password: "employee123" }
    ];
